...
<body>
					...
					<div class="form-horizontal" >
						<fieldset>
							<div class="input-prepend" title="登录账号" data-rel="tooltip">
								...
								<input autofocus class="input-large span10" name="loginCode" 
								id="loginCode" type="text" placeholder="用户名" value="" />
							</div>
							...
							<div class="input-prepend" title="登陆密码" data-rel="tooltip">
								...
								id="password" type="password" placeholder="密码" value="" />
							</div>
							<div class="clearfix"></div>
	...
	<!-- jQuery -->
	<script src="/statics/localjs/jquery-1.7.2.min.js"></script>
	<!-- jQuery UI -->
